...
hl.bind(mainMod .. " + Return", hl.dsp.exec_cmd(terminal))   -- Super+Enter: terminal (spec)
local closeWindowBind = hl.bind(mainMod .. " + C", hl.dsp.window.close())
hl.bind(mainMod .. " + W", hl.dsp.window.close())            -- Super+W: close window (spec)
...
-- Kill lee   hyprshell GUI supports closing focused window via keybind (configurable
